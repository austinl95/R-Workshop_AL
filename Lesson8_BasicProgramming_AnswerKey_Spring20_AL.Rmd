---
title: "Lesson8_BasicProgramming_AnswerKey_Spring20_AL"
...
for(list in 1:10){  #Using "list" as a vessel to represent every item from 1 to 10, starting from 1
  if (list < 10){   #If list is less than 10, execute the following functions
    print(list)     #Since the first value of list in 1:10 is 1, this is executed.
    list = list+1   #Restore the object list as list + 1 so we can continuously evaluate the statement.
...
for(i in scores){
  if (i > 90){
    ...
    print("B")
      ...
      print("yikes you failed, try again!")
}
...
for (myfruit in mybasket){
  for (yourfruit in yourbasket){
    if (myfruit == yourfruit){
      print(paste("I brought", myfruit, "and you brought", yourfruit,", we brought the same thing!"))
    } else {
      print(paste(myfruit, "&", yourfruit, "are not the same. Great! We brought different fruits!"))
    }
  }
}
